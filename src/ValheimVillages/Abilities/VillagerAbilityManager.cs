...
namespace ValheimVillages.Abilities
{
    ...
    public static class VillagerAbilityManager
    {
        ...
        public static bool ActivateMountainStride()
        {
            ...
            {
                var minutes = Mathf.CeilToInt(s_cooldownRemaining / 60f);
                player.Message(MessageHud.MessageType.Center,
        ...
        public static void Update(float dt)
        {
            ...
            if (Input.GetKeyDown(ActivationKey) && HasLearnedMountainStride()) ActivateMountainStride();
        }
        ...
        {
            return Mathf.Max(0f, s_cooldownRemaining);
        }
