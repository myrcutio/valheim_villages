...
namespace ValheimVillages.Algorithms
{
    ...
    public static class ConnectedIslands
    {
        ...
        /// <param name="shouldTest">Returns true if the pair (A, B) should be tested at all.
        /// Use this to limit testing to nearby pairs and avoid O(n^2) connectivity checks.</param>
