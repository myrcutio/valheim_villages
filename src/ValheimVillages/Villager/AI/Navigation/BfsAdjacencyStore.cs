...
namespace ValheimVillages.Villager.AI.Navigation
{
    ...
    {
        public static Dictionary<string, HashSet<string>> Adjacency { get; private set; } = new();

        public static HashSet<string> Seeds { get; private set; } = new();
        ...
        /// </summary>
        public static Dictionary<string, BfsEdgeMeta> EdgeMeta { get; private set; } = new();
