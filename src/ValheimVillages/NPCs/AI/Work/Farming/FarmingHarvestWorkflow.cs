...
namespace ValheimVillages.NPCs.AI.Work.Farming
{
    ...
    public partial class FarmingBehavior
    {
        ...
        private void BeginHarvestPass()
        {
            ...
            var cropTarget = ValheimVillages.NPCs.AI.VillagerMovement.GetWalkableDestination(m_context.CurrentHarvestTarget.transform.position);
        ...
        private void WalkToOutputChest()
        {
            ...
            m_ai.SetState(BehaviorState.Working, new VillagerWaypoint(chestTarget, PathingStrategyRegistry.WorkerId));
            Plugin.Log?.LogDebug(
