namespace ValheimVillages.Villages.Entity
{
    ...
    ///     for UI/logs but does not gate). The legacy <c>wo_range</c>/<c>wo_min</c>/<c>wo_max</c> token keys are no longer written or read as of 0.3.0; they are intentionally
    ...
    public readonly struct WorkOrderEntry
    {
        ...
        public readonly int Max; // the quota cap the scan enforces
